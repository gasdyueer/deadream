...
/** 当前页面若是一篇文章，取出它的元信息 */
const post = computed(() => posts.find((item) => item.file === page.value.relativePath))
</script>

<template>
  <div v-if="post" class="post-meta-bar">
    <span class="post-meta-item">
      <span class="post-meta-label">发布于</span>
    ...
    <span v-if="post.tags.length" class="post-meta-tags">
